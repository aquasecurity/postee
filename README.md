...
Postee supports to use of environment variables for *Output* fields: **User**, **Password** and **Token**. To use, insert the preffix `$` to environment variable in the field of the configuration file, for example:
```
outputs:
- name: my-jira   
  type: jira     
